---
title: "Pat9 Experiment - PTK - 24H Treated"
...
qc_data <- krsa_qc_steps(raw_data) %>%
  ...
  filter(str_detect(Group, "24h_Treated")) |> 
  mutate(
    Group = case_when(
    Group == "Pat9_DMSO_24h_Treated" ~ "DMSO",
    Group == "Pat9_1nM_Plinabulin_24h_Treated" ~ "PLNB-1nM",
    Group == "Pat9_10nM_Plinabulin_24h_Treated" ~ "PLNB-10nM",
    Group == "Pat9_30nM_Plinabulin_24h_Treated" ~ "PLNB-30nM",
  ),
    SampleName = Group
    )
