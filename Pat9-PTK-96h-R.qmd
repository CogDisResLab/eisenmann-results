---
title: "Pat9 Experiment - PTK - 96H Recovery"
...
qc_data <- krsa_qc_steps(raw_data) %>%
  ...
  filter(str_detect(Group, "96h_Recovery")) |> 
  mutate(
    Group = case_when(
    Group == "Pat9_DMSO_96h_Recovery" ~ "DMSO",
    Group == "Pat9_1nM_Plinabulin_96h_Recovery" ~ "PLNB-1nM",
    Group == "Pat9_10nM_Plinabulin_96h_Recovery" ~ "PLNB-10nM",
    Group == "Pat9_30nM_Plinabulin_96h_Recovery" ~ "PLNB-30nM",
  ),
    SampleName = Group
    )
