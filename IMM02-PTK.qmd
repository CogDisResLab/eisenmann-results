...
params:
  ...
  signal_file: "kinome_data/PTK/IMM02-E2_KRSAsOutput_Median_SigmBg_231023122136.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/PTK/IMM02-E2_KRSAsOutput_Signal_Saturation_231023122137.txt" # Change the file name to the one you have
...
qc_data <- krsa_qc_steps(raw_data) %>%
  mutate(
    Group = str_replace(SampleName, " ", "_"),
...
- IMM02 18hr vs DMSO 18hr
- IMM02 30hr vs IMM02 30hr
