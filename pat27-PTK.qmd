---
title: "Pat27 2.5D Cultures Kinome Analysis - PTK"
...
params:
  ...
  signal_file: "kinome_data/PTK/Pat27_KRSAsOutput_Median_SigmBg_231025150248.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/PTK/Pat27_KRSAsOutput_Signal_Saturation_231025150249.txt" # Change the file name to the one you have
...
qc_data <- krsa_qc_steps(raw_data) %>%
  mutate(
    Group = `Comment 1`,
    SampleName = paste0(Group, "_", Barcode, "_", Array)
  )
